    ...
    public function registerPostType()
    {
        ...
        $labels = array_merge(
            ...
            array(
              ...
              'add_new'             => sprintf(__('Add new %s', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->nameSingular)),
              ...
              'new_item'            => sprintf(__('New %s', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->nameSingular)),
              'view_item'           => sprintf(__('View %s', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->nameSingular)),
              'search_items'        => sprintf(__('Search %s', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->namePlural)),
              'not_found'           => sprintf(__('No %s found', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->namePlural)),
              'not_found_in_trash'  => sprintf(__('No %s found in trash', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->namePlural)),
