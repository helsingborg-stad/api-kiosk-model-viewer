...
namespace ApiKioskModelViewer\Helper;
...
class Taxonomy extends PostType
{
    ...
    public function registerTaxonomy()
    {
        ...
        $this->taxonomyLabels = array_merge(
            ...
            array(
                ...
                'search_items'      => sprintf(__('Search %s', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->namePlural)),
                'all_items'         => sprintf(__('All %s', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->namePlural)),
                'parent_item'       => sprintf(__('Parent %s:', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->nameSingular)),
                'parent_item_colon' => sprintf(__('Parent %s:', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->nameSingular)) . ':',
                'edit_item'         => sprintf(__('Edit %s', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->nameSingular)),
                'update_item'       => sprintf(__('Update %s', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->nameSingular)),
                'add_new_item'      => sprintf(__('Add new %s', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->nameSingular)),
                'new_item_name'     => sprintf(__('New %s Name', API_KIOSK_MODEL_VIEWER_TEXT_DOMAIN), strtolower($this->nameSingular)),
    ...
    public function removeResponseKeys($response, $post, $request)
    {
        ...
        $excludeKeys = apply_filters('ApiKioskModelViewer/Helper/Taxonomy::removeResponseKeys', $excludeKeys, $post, $request, $this);
